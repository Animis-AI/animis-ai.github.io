...
- 查看器曝光按资产分档:环境强度 5 / 方向光 1.2 是给剪刀(丢贴图、金属度拉满的深色钢)调的,
  笔记本保留自带材质后整体过曝,近黑塑料被反射成中灰。现在保留自带材质的资产默认走
...
- 环境光强度不能全站一个值:HDRI 柔光箱是 HDR 白,强度 5 下连 albedo 0.018 的黑塑料都反射成中灰;
  保留自带 PBR 的资产要 0.6–1.0,只有丢贴图换常量的深色金属才需要 5。
